...
$LinesLast24Hours = array_slice($lines,-100;
...
foreach ($LinesLast24Hours as $line) {
...
<!DOCTYPE html>
<html>
<a href="sensor_log_file_2.csv" download="sensor_log_file_2.csv">Download plant 2 sensor data</a>
